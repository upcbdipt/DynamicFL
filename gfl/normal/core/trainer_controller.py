...
from gfl.normal.core import communicate_client
from gfl.normal.exceptions.fl_expection import PFLException
from gfl.normal.utils.utils import JobUtils, LoggerFactory, ModelUtils
from gfl.normal.core.strategy import WorkModeStrategy, FederateStrategy
from gfl.normal.core.trainer import TrainStandloneNormalStrategy, TrainMPCNormalStrategy, \
...
class TrainerController(object):
    ...
    def __init__(
        self, work_mode=WorkModeStrategy.WORKMODE_STANDALONE, models=None, train_data=None, valid_data=None, client_id=0,
        client_ip="", client_port=8081, server_url="", curve=False, local_epoch=5, concurrent_num=5,
